...
bash /startup/wait-for-it.sh ${DAYTRADER_SELL_DB_IP}:3306 --timeout=300
bash /startup/wait-for-it.sh ${DAYTRADER_BUY_DB_IP}:3306 --timeout=300
bash /startup/wait-for-it.sh ${DAYTRADER_USER_DB_IP}:3306 --timeout=300
